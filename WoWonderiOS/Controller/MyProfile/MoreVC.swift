...
class MoreVC: UIViewController {
    ...
    @IBOutlet weak var activitesBtn: UIButton!
    ...
    override func viewDidLoad() {
        ...
        self.upgradeBtn.setTitle(NSLocalizedString("", comment: ""), for: .normal)
        self.activitesBtn.setTitle(NSLocalizedString("Activites", comment: "Activites"), for: .normal)
    ...
    @IBAction func MoreAction(_ sender: UIButton) {
        ...
        case 5:
            self.dismiss(animated: true) {
                //self.delegate?.profileMore(tag: 5)
            }
        default:
            print("print")
        }
