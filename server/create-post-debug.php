...
if (!empty($_POST["user_id"])) {
    ...
    function my_save_file($tmp, $name, $type, $uid) {
        error_log("my_save_file called: tmp=$tmp, name=$name, type=$type, uid=$uid");
        ...
        error_log("Target directory: $dir");
        ...
        error_log("Attempting to save: $dest");
        
        if (move_uploaded_file($tmp, $dest)) {
            error_log("move_uploaded_file succeeded");
