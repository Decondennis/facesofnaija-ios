...
class GetPostWithBg_Image :AddReactionDelegate,SharePostDelegate,comment_CountsDelegate{
    ...
    func postWithBg_Image(targetController :UIViewController,tableView : UITableView, indexpath:IndexPath, array : [[String:Any]],stackViewHeight: CGFloat,viewHeight: CGFloat, isHidden: Bool, viewColor :UIColor) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "postWithBg_image") as! PostwithBg_imageCell
        ...
        if let colorId = index["color_id"] as? String{
            if colorId == "2" {
                cell.postImage.image = #imageLiteral(resourceName: "bg2")
                cell.postText.textColor = .white
            }
            else if colorId == "3" {
                cell.postImage.image = #imageLiteral(resourceName: "bg3")
                cell.postText.textColor = .white
            }
                
            else if colorId == "4" {
                cell.postImage.image = #imageLiteral(resourceName: "bg4")
                cell.postText.textColor = .white
            }
                
            else if colorId == "5" {
                cell.postImage.image = #imageLiteral(resourceName: "bg5")
                cell.postText.textColor = .black
            }
                
            else if colorId == "6" {
                cell.postImage.image = #imageLiteral(resourceName: "bg6")
                cell.postText.textColor = .black
            }
                
            else if colorId == "7" {
                cell.postImage.image = #imageLiteral(resourceName: "bg7")
                cell.postText.textColor = .black
            }
        }
        ...
        if let textStatus = index["postText"] as? String {
            cell.postText.text! = textStatus.htmlToString
        }
