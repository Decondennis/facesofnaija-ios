...
class MyProfileCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.followingLbl.text = NSLocalizedString("Friends", comment: "Friends")
        ...
        self.walletBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
    }
