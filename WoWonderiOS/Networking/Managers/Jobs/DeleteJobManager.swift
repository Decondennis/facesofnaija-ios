...
class DeleteJobManager {
    ...
    func deleteJob(postId : String,completionBlock : @escaping (_ Success:
        ...
        AF.request(APIClient.DeleteJob.deleteJobApi + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
