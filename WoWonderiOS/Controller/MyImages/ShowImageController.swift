...
class ShowImageController: UIViewController,AddReactionDelegate,SharePostDelegate{
...
//                                self.dismiss(animated: <#T##Bool#>, completion: <#T##(() -> Void)?##(() -> Void)?##() -> Void#>)
                                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Delete_Album"), object: nil)
                            }
