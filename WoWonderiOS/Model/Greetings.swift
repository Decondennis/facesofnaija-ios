...
//  FacesofnaijaiOS
//
//  Created by MacBook Pro on 18/08/2022.
...
func RandomMorningGreeting () -> String {
    let index = GKRandomSource.sharedRandom().nextInt(upperBound: morningGreetings.count)
    
    return morningGreetings[index]
}

func RandomAfternoonGreeting () -> String {
    let index = GKRandomSource.sharedRandom().nextInt(upperBound: afternoonGreetings.count)
    
    return afternoonGreetings[index]
}

func RandomEveningGreeting() -> String {
    let index = GKRandomSource.sharedRandom().nextInt(upperBound: eveningGreetings.count)
    
    return eveningGreetings[index]
}
