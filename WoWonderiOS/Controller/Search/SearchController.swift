...
//        UIColor.hexStringToUIColor(hex:"#994141")
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        self.filterBtn.isHidden = false
        let child_2 = UIStoryboard(name: "Communities", bundle: nil).instantiateViewController(withIdentifier: "SearchCommunityVC") as! SearchCommunityController
//        self.filterBtn.isHidden = true
        if (self.isFromPage == 1){
            child_2.isFromCommunity = 1
        }
...
//        self.filterBtn.isHidden = true
        ...
        let child_4 = UIStoryboard(name: "Search", bundle: nil).instantiateViewController(withIdentifier: "SearchPageVC") as! SearchPageController
//        self.filterBtn.isHidden = true
        if (self.isFromPage == 1){
            child_4.isFromPage = 1
        }
