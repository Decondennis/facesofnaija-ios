...
class AlbumController: UIViewController,CreateAlbumDelegate{
    ...
    @IBOutlet weak var noAlbumImage: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        self.noAlbumImage.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.noPhotoLbl.text = NSLocalizedString("No Photos !!", comment: "No Photos !!")
        self.textLbl.text = NSLocalizedString("Start uploding your own photos", comment: "Start uploding your own photos")
...
print("abc")
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.DeleteAlbum), name: Notification.Name(rawValue: "Delete_Album"), object: nil)
...
//          self.setupGridView()
    ...
    @objc func DeleteAlbum(){
        self.albums.remove(at: self.selectedIndex)
