...
class SearchFilterController: UIViewController,TTRangeSliderDelegate,SearchDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.all.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.male.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.female.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.ageSwitch.thumbTintColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.ageSlider.minLabelColour = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.ageSlider.maxLabelColour = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.ageSlider.lineBorderColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.ageSlider.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
