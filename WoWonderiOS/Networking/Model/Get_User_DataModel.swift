...
struct get_Uers_DataSuccessModel  {
    ...
    let joined_communities : [[String:Any]]
    }
...
extension Get_User_DataModel.get_Uers_DataSuccessModel{
    init(json : [String:Any]) {
        ...
        let joined_communities = json["joined_communities"] as? [[String:Any]]
        ...
        self.joined_communities = joined_communities ?? [["community_name": "wowonder"]]
    }
