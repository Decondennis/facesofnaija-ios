...
self.navigationController?.navigationBar.topItem?.backBarButtonItem = UIBarButtonItem(title: "", style: .plain, target: self, action: nil)
        ...
        self.noUserLbl.text = NSLocalizedString("No User to show.", comment: "No User to show.")
        self.textLbl.text = NSLocalizedString("Welcome,you are the first user here!", comment: "Welcome,you are the first user here!")
