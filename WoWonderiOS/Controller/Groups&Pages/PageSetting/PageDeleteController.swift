...
class PageDeleteController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.deleteBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
    ...
    @IBAction func CheckBtn(_ sender: Any) {
        if ischeck == 0 {
            self.checkView.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
    ...
    @IBAction func Delete(_ sender: Any) {
        ...
        else if self.checkView.backgroundColor != UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor){
