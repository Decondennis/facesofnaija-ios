...
class PopularPostController: UIViewController,editPostDelegate {
    ...
    func editPost(newtext: String, postPrivacy: String) {
        self.popularPost[self.selectedIndex]["postText"] = newtext
        self.popularPost[self.selectedIndex]["postPrivacy"] = postPrivacy
        self.tableView.reloadData()
    }
