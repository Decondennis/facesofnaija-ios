...
class ShowAllSuggestedCommunities: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("Suggested Communities", comment: "Suggested Communities")
    ...
    private func getSuggestedGroups(){
        ...
        case .online(.wwan),.online(.wiFi):
            GetSuggestedGroupManager.sharedInstance.getGroups(type: "groups", limit: 25) { (success, authError, error) in
                if (success != nil){
...
extension ShowAllSuggestedCommunities: UITableViewDelegate, UITableViewDataSource,JoinGroupDelegate,DeleteGroupDelegate{
