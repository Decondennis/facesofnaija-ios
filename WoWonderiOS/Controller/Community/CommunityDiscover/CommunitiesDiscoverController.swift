...
class CommunitiesDiscoverController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UINib(nibName: "SuggestedCommunityTableCell", bundle: nil), forCellReuseIdentifier: "suggestedTableCell")
        ...
        if (AppInstance.instance.suggested_groups.count == 0){
            ...
            self.suggestedGroups = AppInstance.instance.suggested_groups
    ...
    private func getSuggestedGroups(){
        ...
        case .online(.wwan),.online(.wiFi):
            GetSuggestedGroupManager.sharedInstance.getGroups(type: "groups", limit: 10) { (success, authError, error) in
                if (success != nil){
...
extension CommunitiesDiscoverController: UITableViewDelegate,UITableViewDataSource,DeleteGroupDelegate,JoinGroupDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.section == 0){
            let cell = tableView.dequeueReusableCell(withIdentifier: "suggestedTableCell") as! SuggestedCommunityTableCell
            cell.vc = self
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "CommunityCateTableCell") as! CommunityCategoryTableCell
            cell.vc = self
