...
class GetProductsController: UIViewController,ProductDistanceDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.searchBar.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
...
//        self.gradientView.layer.addSublayer(gradientLayer)
    ...
    @IBAction func MarketProductBtn(_ sender: Any) {
        ...
        self.productsCollectionView.scrollToItem(at: IndexPath(item: 0, section: 0), at: .left, animated: true)
//        scrollToItem(at: IndexPath.init(item: 0, section: 0), at: .left, animated: true)
    ...
    @IBAction func MyProductsBtn(_ sender: Any) {
        self.productsCollectionView.scrollToItem(at: IndexPath(item: 1, section: 0), at: .left, animated: true)
//        scrollToItem(at: IndexPath.init(item: 1, section: 0), at: .right, animated: true)
    ...
    if (collectionView == self.collectionView){
        ...
        if let indx = self.selectIndex{
            if indx == indexPath.item{
                cell.categoryLabel.textColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
//                    UIColor.hexStringToUIColor(hex: "984243")
                cell.categoryView.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
//                    UIColor.hexStringToUIColor(hex: "984243")
            }
            else{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if (collectionView == self.collectionView){
            ...
            selectedCell.categoryLabel.textColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
//                UIColor.hexStringToUIColor(hex: "984243")
            selectedCell.categoryView.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
//                UIColor.hexStringToUIColor(hex: "984243")
