...
class DownloadInfoManager{
    ...
    let params = [
        ...
        AF.request(APIClient.UserInfo.userInfoApi + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
