...
class CreateJobController: UIViewController,uploadImageDelegate,JobTypeDelegate,JobSalaryDelegate,JobCurrencyDelegate,JobCategoryDelegate,UITextFieldDelegate,UITextViewDelegate,getAddressDelegate{
