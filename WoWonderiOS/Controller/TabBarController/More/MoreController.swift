...
class MoreController: UIViewController,UITabBarControllerDelegate {
    ...
    @IBOutlet weak var communities: UIButton!
    ...
    override func viewDidLoad() {
        ...
        self.following.setTitle(NSLocalizedString("Friends", comment: "Friends"), for: .normal)
        ...
        self.communities.setTitle(NSLocalizedString("Communities", comment: "Communities"), for: .normal)
...
//            self.tableView.setContentOffset(CGPoint.zero, animated: true)
    ...
    @IBAction func Buttons(_ sender: UIButton) {
        ...
        case 2:
            ...
            vc.type = "following"
            vc.navTitle = NSLocalizedString("Friends", comment: "Friends")
            self.navigationController?.pushViewController(vc, animated: true)
