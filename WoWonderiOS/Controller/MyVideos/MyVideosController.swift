...
class MyVideosController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.noVideoLbl.text = NSLocalizedString("No Video!!", comment: "No Video!!")
        self.textLbl.text = NSLocalizedString("Start uploding your own video", comment: "Start uploding your own video")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let index = self.myVideos[indexPath.row]
               if let image = index["postFile_full"] as? String{
                ...
                let Url = "\(APIClient.baseURl)/\(image)"
