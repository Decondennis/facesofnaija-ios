            ...
            performUIUpdatesOnMain {
                GetSearchDataManager.sharedInstance.getSearchData(search_keyword: self.keyword, country: self.countryId, status: self._status, verified: self.verified, gender: self.gender, filterbyage: self.filterage, age_from: self.ageFrom, age_to: self.ageTo) { (success, authError, error) in
                    if success != nil{
                        ...
                        let communityInfo = ["communityData" : success!.communities]
                        ...
                        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "loadCommunity"), object: nil, userInfo: communityInfo)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let isFollowing = index["is_following"] as? Int{
            if isFollowing == 0{
                ...
                cell.followingBtn.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
               ...
               if (AppInstance.instance.connectivity_setting == "1"){
                ...
                cell.followingBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
                }
            }
