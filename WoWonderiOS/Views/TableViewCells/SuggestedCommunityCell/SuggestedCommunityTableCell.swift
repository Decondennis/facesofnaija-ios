...
class SuggestedCommunityTableCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,JoinCommunityDelegate,DeleteGroupDelegate {
    ...
    var vc: CommunitiesDiscoverController?
...
//        self.sellLbl.text = NSLocalizedString("See All", comment: "See All")
    ...
    private func JoinCommunity(groupId: String){
...
//                        UIColor.hexStringToUIColor(hex: "#984243")
                    ...
                    self.JoinCommunity(groupId: group_id ?? "")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let isLike = index["is_joined"] as? Bool{
            if isLike == false{
                cell.joinBtn.setTitle(NSLocalizedString("Join Community", comment: "Join Community"), for: .normal)
                cell.joinBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
//                    UIColor.hexStringToUIColor(hex: "#984243")
                cell.joinBtn.setTitleColor(.white, for: .normal)
            }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.communityDelegate?.didSelectItem1(record: record)
    }
...
extension SuggestedCommunityTableCell: CommunityDelegate {
    func didSelectItem1(record: [String : Any]) {
        self.communityDelegate?.didSelectItem1(record: record)
    }
}
