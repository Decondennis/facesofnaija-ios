...
class SavedPostController: UIViewController,editPostDelegate {
...
//            UIColor.hexStringToUIColor(hex: "#984243")
    ...
    func editPost(newtext: String, postPrivacy: String) {
        self.posts[self.selectedIndex]["postText"] = newtext
        self.posts[self.selectedIndex]["postPrivacy"] = postPrivacy
        self.tableView.reloadData()
    }
