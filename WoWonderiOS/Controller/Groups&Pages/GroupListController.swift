...
class GroupListController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //        self.getGroups()
        if (AppInstance.instance.myGroups.count != 0){
            self.myGroups = AppInstance.instance.myGroups
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            if (self.isGroupExist == 1){
                ...
                cell.noGroupview.isHidden = true
                ...
                let cell = tableView.dequeueReusableCell(withIdentifier: "JoinGroup") as! JoinedGroupCell
                cell.noGroupview.isHidden = false
