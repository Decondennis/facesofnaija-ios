...
class PageSettingController: UIViewController,EditPageDelegete,DeletePageDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.pageInfoBtn.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
        self.actionButton.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
        self.linkBtn.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
        self.offerBtn.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
        ...
        self.pageInfoBtn.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.actionButton.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.linkBtn.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.offerBtn.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
