...
class PostHashTagController: UIViewController,editPostDelegate {
...
//            UIColor.hexStringToUIColor(hex: "#984243")
    ...
    func editPost(newtext: String, postPrivacy: String) {
        self.hashTagPosts[self.selectedIndex]["postText"] = newtext
        self.hashTagPosts[self.selectedIndex]["postPrivacy"] = postPrivacy
        self.tableView.reloadData()
    }
