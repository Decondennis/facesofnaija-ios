...
class CreateProductController: UIViewController,getAddressDelegate,UITextViewDelegate {
    ...
    var productType = ""
    var isHome = 0
    var delgate1: loadEventDelegate?
                    ...
                    if success != nil {
                       ...
                       if self.isHome == 0{
                        ...
                        self.dismiss(animated: true) {
                            self.delgate1?.loadEvent(type: "create_product")
                        }
                       }
