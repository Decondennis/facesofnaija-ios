...
//        "\("https://demo.wowonder.com/api/events")\(access_token)"
          ...
          }, with: "\(APIClient.Events.editEvent)\(access_token)" as! URLRequestConvertible)
...
//          },to: "\("https://demo.wowonder.com/api/events")\(access_token)", usingThreshold: UInt64.init(),method: .post,headers: nil){
//              (result) in
//              switch result{
