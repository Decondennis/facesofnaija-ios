...
class JoinGroupManager {
    ...
    let params = [APIClient.Params.serverKey : APIClient.SERVER_KEY.Server_Key, APIClient.Params.groupId : groupId] as [String : Any]
        ...
        AF.request(APIClient.JoinGroup.joinGroupAPi + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
