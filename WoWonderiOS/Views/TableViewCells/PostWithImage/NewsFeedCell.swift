...
class NewsFeedCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.commentsCountBtn.addTarget(self, action: #selector(self.CommentTapped(_:)), for: .touchUpInside)
        ...
        self.sharesCountBtn.addTarget(self, action: #selector(ShareTapped(_:)), for: .touchUpInside)
