...
extension MyPointsVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                vc.URLString = "\(APIClient.baseURl)/contact-us"
            ...
            case 0:
                vc.URLString = "\(APIClient.baseURl)/terms/about-us"
                vc.title = "About Us"
            case 1:
                vc.URLString = "\(APIClient.baseURl)/terms/privacy-policy"
                vc.title = "Privacy Policy"
            case 2:
                vc.URLString = "\(APIClient.baseURl)/terms/terms"
