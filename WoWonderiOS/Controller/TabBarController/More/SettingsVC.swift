...
class SettingsVC: BaseVC,UITabBarControllerDelegate,loadEventDelegate,createLiveDelegate{
...
//            UIColor.hexStringToUIColor(hex: "994141")
    ...
    func showLogs(){
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("Request New Community", comment: "Request New Community"), style: .default, handler: { (_) in
            let storyboard = UIStoryboard(name: "Communities", bundle: nil)
            let vc = storyboard.instantiateViewController(withIdentifier: " ") as! CommunityRequestController
            vc.isHome = 1
...
//        tableView.register(UINib(nibName: "SettingsTableItem", bundle: nil), forCellReuseIdentifier: "SettingsTableItem")
        ...
        self.data = [
            ...
            DataSet(title: NSLocalizedString("Communities", comment: "Communities"), image: UIImage(named: "groupes")),
        ...
        DataSet(title: NSLocalizedString("Tell A Friend", comment: "Tell A Friend"), image: UIImage(named: "home-page")),
