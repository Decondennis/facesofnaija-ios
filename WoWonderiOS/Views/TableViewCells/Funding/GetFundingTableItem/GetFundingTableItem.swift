...
class GetFundingTableItem: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.amountLabel.textColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.usernameLabel.textColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
    }
